                    ...
                    presentRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.exists()){
                                ...
                                final TextView presentTV,absentTV,name,id;
                                Button button;
                                ...
                                cardViewAttendance = view.findViewById(R.id.qrcode);
                                ...
                                cardViewAttendance.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(ShowAttendanceActivity.this, GenerateQRCodeActivity.class);
